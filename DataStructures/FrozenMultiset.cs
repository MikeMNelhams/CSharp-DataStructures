...
{
    public class FrozenMultiSet<T> : MultiSet<T>, IEquatable<FrozenMultiSet<T>> where T : notnull
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((FrozenMultiSet<T>)obj);
        }
        ...
        static int GetOrderIndependentHashCode<G>(IEnumerable<G> source) where G : notnull
        {
